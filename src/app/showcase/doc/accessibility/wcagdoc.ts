    ...
    template: ` <section>
        <app-docsectiontext [title]="title" [id]="id">
            <p>
                ...
                Web Consortium). WCAG consists of recommendations for making the web content more accessible. QiusNG components aim high level of WCAG compliancy in the near future.
            </p>
            <p>
