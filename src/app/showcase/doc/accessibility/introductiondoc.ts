    ...
    template: ` <section>
        <app-docsectiontext [title]="title" [id]="id">
            <p class="line-height-3  bg-indigo-600 text-white p-3 text-lg" style="border-radius: 10px;">
                Accessibility is a major concern of the Qius UI libraries and QiusNG is no exception. <a href="https://www.qius.solutions.com.tr" class="text-white">Qius Solutions</a> teams have initiated a significant process to review and enhance the
                accessibility features of the components. This guide documents the foundation of the general guidelines that QiusNG will follow and each component documentation will have a separate <b>Accessibility</b> section that states the
                ...
                <a href="https://www.qius.solutions.com.tr" class="hover:underline text-white font-bold">QiusVue</a> as the reference implementation and it will be ported to QiusNG in Q2 2023.
            </p>
            <p>
