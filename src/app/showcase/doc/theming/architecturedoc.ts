...
@Component({
    ...
    template: ` <section>
        <app-docsectiontext [title]="title" [id]="id">
            ...
            <p>
                QiusNG is a design agnostic library so unlike other UI libraries it does not enforce a certain styling such as material or bootstrap. In order to achieve this, styling has been separated into two parts, core and theme. The core
                resides inside QiusNG to implement the structure of the components such as positioning whereas theme brings the colors and spacing.
            </p>
        </app-docsectiontext>
        <img alt="Architecture" src="https://qius.solutions.org/cdn/qiusng/images/architecture.jpg" class="w-full mb-5" />
    </section>`
})
